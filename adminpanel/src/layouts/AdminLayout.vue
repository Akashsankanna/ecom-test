...
const navItems = [
  ...
  { label: 'Orders',       icon: 'shopping_cart',      route: '/admin/orders',        badge: '5',  badgeColor: 'warning' },
  { label: 'Payments',     icon: 'payments',           route: '/admin/payments',      badge: '3',  badgeColor: 'negative' },
