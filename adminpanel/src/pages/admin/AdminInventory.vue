          ...
          <table class="dtbl">
            ...
            <tbody v-else>
              <tr
                ...
                :key="v.id"
                class="dtbl__row"
                :class="{ 'dtbl__row--warn': v.stock <= v.low_stock_threshold }"
              >
                <td>
                ...
                <td>
                  <code class="sku-tag">{{ v.sku || '—' }}</code>
                </td>

                <td>
                  <div class="color-size">
                    <span v-if="v.hex_code" class="color-dot" :style="{ background: v.hex_code }" />
                ...
                <td class="tc">
                  <span
                    class="num-avail"
                    :class="{
                      'num-avail--low': v.stock - (v.reserved_stock ?? 0) <= v.low_stock_threshold,
                    }"
                  >
            ...
            <tbody v-else>
              <tr v-for="log in filteredLogs" :key="log.id" class="dtbl__row">
                ...
                <td>
                  <span
                    class="log-type-pill"
                    :class="`ltp--${(log.change_type || '').toLowerCase()}`"
                  >
                ...
                <td>
                  <span class="note-text">{{ log.notes || '—' }}</span>
                </td>
                <td>
      ...
      <div v-show="activeTab === 'adjustments'">
        <div class="adj-grid">
          ...
          <div class="adj-card adj-card--add">
            ...
            <div class="adj-form">
              ...
              <div class="fld">
                ...
                <input
                  v-model.number="addForm.reference_id"
                  type="number"
                  class="inp"
              ...
              <div class="fld fld--full">
                ...
                <input
                  ...
                  class="inp"
                  placeholder="e.g. April shipment batch"
                />
              </div>
              <q-btn
                unelevated
                no-caps
                class="adj-submit adj-submit--add"
                icon="add"
                label="Add Stock"
                :loading="addLoading"
          ...
          <div class="adj-card adj-card--remove">
            <div class="adj-card__hdr">
              <div class="adj-icon adj-icon--remove">
            ...
            <div class="adj-form">
              ...
              <div class="fld">
                <label>Reference ID <span class="opt">(optional)</span></label>
                <input
                  v-model.number="removeForm.reference_id"
                  type="number"
                  class="inp"
                  placeholder="e.g. order ID"
                />
              ...
              <q-btn
                unelevated
                no-caps
                class="adj-submit adj-submit--remove"
                icon="remove"
                label="Remove Stock"
          ...
          <div class="adj-card adj-card--reserve">
            <div class="adj-card__hdr">
              <div class="adj-icon adj-icon--reserve">
            ...
            <div class="adj-form">
              ...
              <div class="fld">
                <label>Reference ID <span class="opt">(optional)</span></label>
                <input
                  v-model.number="reserveForm.reference_id"
                  type="number"
                  class="inp"
              ...
              <div class="fld fld--full">
                ...
                <input
                  ...
                  class="inp"
                  placeholder="e.g. Bulk order #BO-001"
                />
              </div>
              <q-btn
                unelevated
                no-caps
                class="adj-submit adj-submit--reserve"
                icon="lock_outline"
                label="Reserve Stock"
          ...
          <div class="adj-card adj-card--release">
            ...
            <div class="adj-form">
              ...
              <div class="fld">
                <label>Reference ID <span class="opt">(optional)</span></label>
                <input
                  v-model.number="releaseForm.reference_id"
                  type="number"
                  class="inp"
              ...
              <div class="fld fld--full">
                ...
                <input
                  ...
                  class="inp"
                  placeholder="e.g. Order cancelled — releasing hold"
                />
              </div>
              <q-btn
                unelevated
                no-caps
                class="adj-submit adj-submit--release"
                icon="lock_open"
                label="Release Stock"
    ...
    <q-dialog v-model="drawerOpen" position="right" full-height>
      ...
      >
        <div class="drawer-hdr">
          <div>
            <div style="font-weight: 700; font-size: 15px; color: #0f1520">
              {{ drawerVariant?.product_name }}
            </div>
        ...
        <div style="flex: 1; overflow-y: auto; padding: 18px" v-if="drawerVariant">
          ...
          <div class="drawer-stats">
            <div class="dstat">
              <div class="dstat__val">{{ drawerVariant.stock }}</div>
              <div class="dstat__lbl">Total</div>
            </div>
            <div class="dstat">
              <div class="dstat__val" style="color: #d97706">
                {{ drawerVariant.reserved_stock ?? 0 }}
              </div>
              <div class="dstat__lbl">Reserved</div>
            </div>
            <div class="dstat">
              <div class="dstat__val" style="color: #15803d">
                {{ (drawerVariant.stock || 0) - (drawerVariant.reserved_stock || 0) }}
              </div>
              <div class="dstat__lbl">Available</div>
            </div>
            <div class="dstat">
              <div class="dstat__val" style="color: #1d4ed8">
                {{ drawerVariant.low_stock_threshold }}
              </div>
              <div class="dstat__lbl">Threshold</div>
            </div>
          </div>

          <div class="drawer-section-title">Recent Activity</div>
          <div v-if="drawerLogsLoading" style="text-align: center; padding: 20px">
            <q-spinner-dots color="blue-5" size="28px" />
          </div>
          <div
            v-else-if="drawerLogs.length === 0"
            style="color: #9ca3af; font-size: 13px; padding: 12px 0"
          >
      ...
      <q-card class="modal-card">
        ...
        <div style="padding: 18px 20px">
          <div class="fld" style="margin-bottom: 14px">
            ...
            <input
              v-model.number="settingsForm.stock"
              type="number"
              min="0"
              class="inp"
          ...
          <div class="fld">
            ...
            <input
              v-model.number="settingsForm.low_stock_threshold"
              type="number"
              min="0"
              class="inp"
              placeholder="e.g. 10"
        ...
        <div style="padding: 18px 20px">
          ...
          >
            ...
            <div class="fld" v-if="quickConfig.showChangeType">
              ...
              <select v-model="quickForm.change_type" class="sel sel--full">
                <option v-for="ct in quickConfig.changeTypes" :key="ct" :value="ct">
                  {{ ct }}
                </option>
              </select>
            </div>
            <div class="fld">
              ...
              <input
                v-model.number="quickForm.reference_id"
                type="number"
                class="inp"
                placeholder="e.g. 42"
              />
          ...
          <div class="fld">
            ...
            <input
              ...
              class="inp"
              :placeholder="quickConfig.notesPlaceholder"
            />
          </div>
        </div>
        <div class="modal-footer">
          ...
          <q-btn
            unelevated
            no-caps
            :label="quickConfig.btnLabel"
            :color="quickConfig.btnColor"
...
const DEDUCTION_SET = new Set(['ORDER', 'EXCHANGE', 'ADJUSTMENT', 'DAMAGED'])

// UPDATED: Removed 'lowstock' tab
const tabs = [
...
async function fetchVariants() {
  ...
  try {
    ...
    variants.value = Array.isArray(data) ? data : Array.isArray(data.items) ? data.items : []
...
async function fetchDrawerLogs(id) {
  ...
  try {
    ...
    drawerLogs.value = Array.isArray(data) ? data : Array.isArray(data.items) ? data.items : []
  } catch (e) {
    showToast(e.message, 'err')
  } finally {
...
async function refresh() {
  await Promise.all([fetchVariants(), fetchLogs()])
}
