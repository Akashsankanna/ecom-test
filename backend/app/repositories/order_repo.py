...
class OrderRepository:
    ...
    @staticmethod
    def get_all_return_requests(db: Session, status: Optional[str] = None) -> List[ReturnRequest]:
    ...
    @staticmethod
    def get_all_exchanges(db: Session, status: Optional[str] = None) -> List[ExchangeRequest]:
