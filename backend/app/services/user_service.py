...
class UserService:
    ...
    def get_user_detail(
        ...
        user, roles = UserService.get_user(
            db,
            user_id
        )
    ...
    def update_user(
        ...
        name_val = (
            ...
            else getattr(user, "name", user["name"])
        )

        phone_val = (
            data.phone
            if data.phone is not None
            else getattr(user, "phone", user["phone"])
        )
    ...
    def assign_role(
        ...
        valid_role_names = [
            getattr(r, "role_name", r["role_name"])
            for r in all_roles
        ]
    ...
    def get_user_access_view(
        ...
        return UserRepository.get_user_access_view(
            db
        )
    ...
    def get_user_full_access(
        ...
        return UserRepository.get_user_full_access(
            db
        )
